...
A = Trie()
print("Inserto art, amo, ac, amor, amar, acer, am, amaste, a")
insert(A, "art")
insert(A, "amo")
insert(A, "ac")
insert(A, "amor")
...
imprimir(A, "a", 3)
print("Imprimo palabras que empiecen con am y tengan una longitud de 4")
imprimir(A, "am", 4)
print("Imprimo palabras que empiecen con a y tengan una longitud de 1")
imprimir(A, "a", 1)
...
trieLinkedList.insert(A, "amar")
trieLinkedList.insert(A, "acer")
trieLinkedList.insert(A, "am")
trieLinkedList.insert(A, "amaste")
trieLinkedList.insert(A, "a")
print("Imprimo palabras que empiecen con a y tengan una longitud de 3")
trieLinkedList.imprimir(A, "a", 3)
print("Imprimo palabras que empiecen con am y tengan una longitud de 4")
trieLinkedList.imprimir(A, "am", 4)
print("Imprimo palabras que empiecen con a y tengan una longitud de 1")
trieLinkedList.imprimir(A, "a", 1)
