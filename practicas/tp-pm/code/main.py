...
print(pm.rabinKarp("amantoco", "toco"))
print(pm.rabinKarp("asdbaababaca", "ababaca"))
print(pm.rabinKarp("asdbaababaca", "ababdaca"))
print(pm.rabinKarp("asdbaababaca", "ab"))
print(pm.rabinKarp("asdbaababaca", "asd"))
print(pm.rabinKarp("asdbaababaca", "ast"))